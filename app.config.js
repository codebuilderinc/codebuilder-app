...
module.exports = {
    expo: {
        ...
        android: {
            ...
            /**
             * Permissions aligned to AndroidManifest.xml (deduped + invalid removed).
             *
             * Notes:
             * - Removed "NOTIFICATIONS" (not a real Android permission; POST_NOTIFICATIONS is the real one).
             * - Removed ACCESS_MOCK_LOCATION (not in the manifest we aligned to; also not generally grantable).
             * - Many of the "System/Signature/Privileged" permissions will NOT be granted to normal apps.
             *   They’re here only because your manifest included them.
             */
            permissions: [
                // =========================================================
                // Core app permissions (commonly used by regular apps)
                // =========================================================
                ...
                // Foreground services (base + typed)
                ...
                // =========================================================
                // Runtime permissions (prompted at runtime when used)
                // =========================================================
                ...
                // Storage (legacy scoped storage era)
                'android.permission.READ_EXTERNAL_STORAGE',
                'android.permission.WRITE_EXTERNAL_STORAGE',

                // =========================================================
                // Special access / Settings-granted (not normal runtime prompts)
                // =========================================================
                ...
                // =========================================================
                // System / signature / privileged (won’t be granted to normal apps)
                // =========================================================
                ...
                // The remaining system-ish items from your aligned manifest block
